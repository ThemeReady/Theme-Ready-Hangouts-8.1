...
.field private final k:Lqd;

.field private final l:Lqd;

.field private final m:Lox;

.field private final n:Lox;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->c:Loq;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Lop;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->e:Lop;
    ...
    invoke-direct {v2, p0, v3}, Lox;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lox;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lox;

    .line 360
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lox;

    invoke-static {p0, v5, v2}, Lqd;->a(Landroid/view/ViewGroup;FLqg;)Lqd;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lqd;

    .line 361
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lqd;

    invoke-virtual {v2, v4}, Lqd;->a(I)V

    .line 362
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lqd;

    invoke-virtual {v2, v1}, Lqd;->a(F)V

    .line 363
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lox;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lqd;

    invoke-virtual {v2, v3}, Lox;->a(Lqd;)V

    .line 365
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lox;

    invoke-static {p0, v5, v2}, Lqd;->a(Landroid/view/ViewGroup;FLqg;)Lqd;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lqd;

    .line 366
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lqd;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Lqd;->a(I)V
    ...
    .line 368
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lox;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lqd;

    invoke-virtual {v1, v2}, Lox;->a(Lqd;)V
    ...
    invoke-direct {v1, p0}, Loo;-><init>(Landroid/support/v4/widget/DrawerLayout;)V
    ...
    .line 378
    invoke-static {p0}, Lks;->m(Landroid/view/View;)Z
    ...
    .line 379
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->c:Loq;

    invoke-interface {v1, p0}, Loq;->a(Landroid/view/View;)V

    .line 380
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->c:Loq;

    invoke-interface {v1, p1}, Loq;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method private static a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    invoke-static {p0}, Lfv;->a(Landroid/graphics/drawable/Drawable;)Z
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lqd;
    ...
    .line 554
    :cond_4
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lqd;
...
.method public a(ILandroid/view/View;)V
    ...
    .line 684
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lqd;

    invoke-virtual {v3}, Lqd;->a()I
    ...
    .line 707
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->v:Lot;
    ...
    invoke-interface {v0, v1}, Lot;->a(I)V
...
.method a(Landroid/view/View;F)V
    ...
    invoke-interface {v0, p1, p2}, Lot;->a(Landroid/view/View;F)V
...
.method public a(Lot;)V
    ...
    .prologue
    .line 504
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->v:Lot;
...
.method a(Z)V
    ...
    .line 1410
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lqd;
    ...
    invoke-virtual {v7, v5, v6, v8}, Lqd;->a(Landroid/view/View;II)Z
    ...
    .line 1413
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lqd;
    ...
    invoke-virtual {v6, v5, v7, v8}, Lqd;->a(Landroid/view/View;II)Z
    ...
    .line 1420
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lox;

    invoke-virtual {v0}, Lox;->a()V

    .line 1421
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lox;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 1748
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->e:Lop;
...
.method b(Landroid/view/View;)V
    ...
    .line 715
    iget-boolean v1, v0, Lou;->d:Z

    if-eqz v1, :cond_1

    .line 716
    iput-boolean v2, v0, Lou;->d:Z
    ...
    invoke-interface {v0, p1}, Lot;->b(Landroid/view/View;)V
...
.method c(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Lot;->a(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Lqd;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lqd;

    invoke-virtual {v1, v4}, Lqd;->a(Z)Z
...
.method public e(I)V
    ...
    invoke-static {v3}, Landroid/support/v4/widget/DrawerLayout;->i(I)Ljava/lang/String;
...
.method public g(Landroid/view/View;)Z
    ...
    .line 1272
    invoke-static {p1}, Lks;->e(Landroid/view/View;)I
...
.method protected generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, v1}, Lou;-><init>(II)V
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Lou;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Lou;-><init>(Lou;)V
    ...
    invoke-direct {v0, p1}, Lou;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Lou;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public h(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Lqd;->a(Landroid/view/View;II)Z
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1194
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->c:Loq;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->D:Ljava/lang/Object;

    invoke-interface {v0, v1}, Loq;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v3, p1}, Lqd;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lqd;

    invoke-virtual {v4, p1}, Lqd;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 1294
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lqd;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Lqd;->b(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Lqd;->c(I)Z
...
.method protected onLayout(ZIIII)V
    ...
    .line 1043
    iget v1, v0, Lou;->leftMargin:I

    iget v2, v0, Lou;->topMargin:I

    iget v3, v0, Lou;->leftMargin:I
    ...
    .line 1067
    iget v4, v0, Lou;->topMargin:I

    add-int/2addr v9, v2

    iget v11, v0, Lou;->topMargin:I
    ...
    .line 1074
    iget v10, v0, Lou;->bottomMargin:I
    ...
    iget v11, v0, Lou;->bottomMargin:I
    ...
    iget v13, v0, Lou;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    .line 927
    invoke-static {v7}, Lks;->m(Landroid/view/View;)Z
    ...
    .line 928
    sget-object v9, Landroid/support/v4/widget/DrawerLayout;->c:Loq;

    iget-object v10, p0, Landroid/support/v4/widget/DrawerLayout;->D:Ljava/lang/Object;

    invoke-interface {v9, v7, v10, v8}, Loq;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    .line 936
    iget v8, v0, Lou;->leftMargin:I

    sub-int v8, v2, v8

    iget v9, v0, Lou;->rightMargin:I
    ...
    .line 938
    iget v9, v0, Lou;->topMargin:I

    sub-int v9, v1, v9

    iget v0, v0, Lou;->bottomMargin:I
    ...
    invoke-interface {v9, v0, v10, v8}, Loq;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    invoke-static {v8}, Landroid/support/v4/widget/DrawerLayout;->i(I)Ljava/lang/String;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1699
    invoke-virtual {p1}, Lov;->getSuperState()Landroid/os/Parcelable;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Lov;-><init>(Landroid/os/Parcelable;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Lqd;->b(Landroid/view/MotionEvent;)V
    ...
    .line 1347
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lqd;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Lqd;->b(II)Landroid/view/View;
