...
.field private static final c:Lasb;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Larz;->d:Ljava/util/Set;

    .line 69
    const/4 v0, 0x0

    invoke-static {v0}, Lawd;->a(I)Ljava/util/Queue;

    move-result-object v0

    sput-object v0, Larz;->e:Ljava/util/Queue;

    return-void
.end method

.method public constructor <init>(Landroid/util/DisplayMetrics;Lamo;Lamr;)V
    .locals 1
    ...
    iput-object v0, p0, Larz;->g:Landroid/util/DisplayMetrics;
...
.method private a(Ljava/io/InputStream;)I
    ...
    iget-object v2, p0, Larz;->h:Lamr;

    invoke-direct {v1, p1, v2}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/io/InputStream;Lamr;)V
...
.method private a(Ljava/io/InputStream;Lajc;)Landroid/graphics/Bitmap$Config;
    .locals 6
...
.method private static a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lasb;)Landroid/graphics/Bitmap;
    .locals 10
    ...
    .line 7060
    sget-object v3, Lasm;->a:Ljava/util/concurrent/locks/Lock;
    ...
    .line 8060
    sget-object v1, Lasm;->a:Ljava/util/concurrent/locks/Lock;
    ...
    .line 8467
    invoke-static {p1}, Larz;->b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
...
.method private static b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
    ...
    invoke-static {v0}, Larz;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
...
.method private b(Ljava/io/InputStream;)Z
    ...
    .line 335
    sget-object v1, Larz;->d:Ljava/util/Set;
...
.method private static declared-synchronized c()Landroid/graphics/BitmapFactory$Options;
    ...
    :try_start_0
    sget-object v2, Larz;->e:Ljava/util/Queue;
    ...
    .line 483
    :try_start_1
    sget-object v0, Larz;->e:Ljava/util/Queue;
    ...
    .line 487
    invoke-static {v0}, Larz;->d(Landroid/graphics/BitmapFactory$Options;)V
    :try_end_2
...
.method private static c(Landroid/graphics/BitmapFactory$Options;)V
    ...
    .prologue
    .line 494
    invoke-static {p0}, Larz;->d(Landroid/graphics/BitmapFactory$Options;)V

    .line 495
    sget-object v1, Larz;->e:Ljava/util/Queue;
...
# virtual methods
.method public a(Ljava/io/InputStream;IILajk;)Lamc;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public a(Ljava/io/InputStream;IILajk;Lasb;)Lamc;
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v2, v0, Larz;->h:Lamr;

    const/high16 v3, 0x10000

    invoke-virtual {v2, v3}, Lamr;->a(I)[B

    move-result-object v9

    .line 138
    invoke-static {}, Larz;->c()Landroid/graphics/BitmapFactory$Options;
    ...
    invoke-virtual {v0, v2}, Lajk;->a(Lajh;)Ljava/lang/Object;
    ...
    .line 142
    sget-object v3, Larz;->b:Lajh;

    move-object/from16 v0, p4

    invoke-virtual {v0, v3}, Lajk;->a(Lajh;)Ljava/lang/Object;
    ...
    invoke-static {v0, v10, v1}, Larz;->a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lasb;)Landroid/graphics/Bitmap;
    ...
    .line 4164
    invoke-direct/range {p0 .. p1}, Larz;->a(Ljava/io/InputStream;)I
    ...
    invoke-direct {v0, v1, v2}, Larz;->a(Ljava/io/InputStream;Lajc;)Landroid/graphics/Bitmap$Config;
    ...
    .line 5295
    :cond_3
    invoke-direct/range {p0 .. p1}, Larz;->b(Ljava/io/InputStream;)Z
    ...
    .line 5297
    invoke-static {v10}, Larz;->a(Landroid/graphics/BitmapFactory$Options;)Z
    ...
    .line 5475
    invoke-interface {v3, v5, v7, v2}, Lamo;->b(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    iget-object v2, v0, Larz;->f:Lamo;

    move-object/from16 v0, p5

    invoke-interface {v0, v2, v3}, Lasb;->a(Lamo;Landroid/graphics/Bitmap;)V
    ...
    .line 6426
    invoke-static {v3}, Larz;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    .line 6428
    invoke-static {v10}, Larz;->b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
    ...
    iget-object v2, v0, Larz;->g:Landroid/util/DisplayMetrics;
    ...
    invoke-static {v2, v3, v12}, Lasm;->a(Lamo;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    iget-object v4, v0, Larz;->f:Lamo;

    invoke-interface {v4, v3}, Lamo;->a(Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v2, v3}, Larl;->a(Landroid/graphics/Bitmap;Lamo;)Larl;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 149
    invoke-static {v10}, Larz;->c(Landroid/graphics/BitmapFactory$Options;)V

    .line 150
    move-object/from16 v0, p0

    iget-object v3, v0, Larz;->h:Lamr;

    invoke-virtual {v3, v9}, Lamr;->a([B)V
    ...
    :cond_9
    :try_start_1
    invoke-virtual {v3, v8, v6, v5, v7}, Larr;->a(IIII)F
    ...
    :cond_c
    :try_start_2
    invoke-virtual {v3, v6, v8, v5, v7}, Larr;->a(IIII)F
