...
.method public static a(Landroid/content/Context;ILjava/lang/String;J)J
    ...
    invoke-interface {v0, p2, p3, p4}, Lhww;->a(Ljava/lang/String;J)J
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lbfq;
    .locals 6
    ...
    .line 621
    invoke-virtual {v0, v1, v2}, Lhwx;->b(Ljava/lang/String;Ljava/lang/String;)Lhwx;
    ...
    invoke-direct/range {v0 .. v5}, Lbfq;-><init>(Lhwu;Laxb;Leqa;Ljava/lang/String;Ljava/lang/String;)V

    .line 627
    return-object v0
.end method

.method public static a(Landroid/content/Context;I)Ldad;
    .locals 4
    ...
    invoke-interface {v0, v2, v1}, Lhww;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v0, v3, v1}, Lhww;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 182
    :cond_1
    invoke-static {p0}, Laat;->e(Landroid/content/Context;)Ljava/io/File;

    .line 183
    return-object v1
.end method

.method public static a(Lhww;)Ljava/util/Map;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0, v1}, Lhww;->a(Ljava/lang/String;Ljava/util/Set;)Ljava/util/Set;
    ...
    .line 1231
    invoke-static {v0}, Ldlj;->a(Ljava/lang/String;)Ldlj;
...
.method private static a(Ljava/util/Map;)Ljava/util/Set;
    ...
    .line 1248
    invoke-virtual {v0}, Ldlj;->toString()Ljava/lang/String;
...
.method public static a(Landroid/content/Context;ILjava/lang/String;)V
    ...
    invoke-virtual {v0, p2, v4, v5}, Lhwx;->a(Ljava/lang/String;J)J

    move-result-wide v4

    add-long/2addr v2, v4

    invoke-virtual {v0, p2, v2, v3}, Lhwx;->b(Ljava/lang/String;J)Lhwx;
...
.method public static a(Landroid/content/Context;Lbfq;J)V
    .locals 2
    ...
    .line 1112
    invoke-virtual {v0, v1, p2, p3}, Lhwx;->b(Ljava/lang/String;J)Lhwx;
...
.method public static a(Landroid/content/Context;Lbfq;Z)V
    .locals 3
...
.method private static a(Landroid/content/Context;[Ljava/lang/Integer;)V
    ...
    invoke-direct {v1, p1, p0}, Lbft;-><init>([Ljava/lang/Integer;Landroid/content/Context;)V
...
.method public static a(Lhwx;Ljava/lang/String;[B)V
    .locals 1
    ...
    invoke-virtual {p0, p1, v0}, Lhwx;->b(Ljava/lang/String;Ljava/lang/String;)Lhwx;

    .line 1366
    return-void
.end method

.method public static a(Lhwz;Ldad;Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;Ljava/util/Map;Lbfr;[Ljava/lang/String;Z)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0, v2}, Lhwz;->c(Ljava/lang/String;Ljava/lang/String;)Lhwz;
    ...
    invoke-interface {p0, v0, p2}, Lhwz;->c(Ljava/lang/String;Ljava/lang/String;)Lhwz;

    .line 657
    const-string v0, "is_google_plus"

    invoke-interface {p0, v0, p3}, Lhwz;->c(Ljava/lang/String;Z)Lhwz;

    .line 658
    const-string v0, "domain_name"

    invoke-interface {p0, v0, p4}, Lhwz;->c(Ljava/lang/String;Ljava/lang/String;)Lhwz;

    .line 659
    const-string v0, "show_chat_warning"

    invoke-interface {p0, v0, p9}, Lhwz;->c(Ljava/lang/String;Z)Lhwz;
    ...
    invoke-interface {p0, v0}, Lhwz;->i(Ljava/lang/String;)Lhwz;
    ...
    invoke-interface {p0, v0, p5}, Lhwz;->c(Ljava/lang/String;Ljava/lang/String;)Lhwz;
    ...
    .line 675
    invoke-static {p6}, Lbfs;->a(Ljava/util/Map;)Ljava/util/Set;

    move-result-object v2

    .line 674
    invoke-interface {p0, v0, v2}, Lhwz;->c(Ljava/lang/String;Ljava/util/Set;)Lhwz;
    ...
    iget-boolean v2, p7, Lbfr;->c:Z

    invoke-interface {p0, v0, v2}, Lhwz;->c(Ljava/lang/String;Z)Lhwz;

    .line 679
    const-string v0, "blocked_for_child"

    iget-boolean v2, p7, Lbfr;->d:Z
    ...
    invoke-interface {p0, v0, v2}, Lhwz;->c(Ljava/lang/String;I)Lhwz;

    .line 692
    const-string v0, "is_gv_sms_integration_enabled"

    iget-boolean v2, p7, Lbfr;->h:Z

    invoke-interface {p0, v0, v2}, Lhwz;->c(Ljava/lang/String;Z)Lhwz;

    .line 695
    iget-object v0, p7, Lbfr;->u:Ljava/lang/String;
    ...
    iget-object v2, p7, Lbfr;->u:Ljava/lang/String;

    invoke-interface {p0, v0, v2}, Lhwz;->c(Ljava/lang/String;Ljava/lang/String;)Lhwz;

    .line 699
    :cond_5
    iget-object v0, p7, Lbfr;->v:Ljava/lang/Integer;
    ...
    iget-object v2, p7, Lbfr;->v:Ljava/lang/Integer;
    ...
    .line 700
    invoke-interface {p0, v0, v1}, Lhwz;->c(Ljava/lang/String;I)Lhwz;

    .line 704
    :cond_6
    const-string v0, "paid_dasher_user"

    iget-boolean v1, p7, Lbfr;->i:Z

    invoke-interface {p0, v0, v1}, Lhwz;->c(Ljava/lang/String;Z)Lhwz;

    .line 705
    const-string v0, "is_history_forced"

    iget-boolean v1, p7, Lbfr;->j:Z
...
.method public static a(Landroid/content/Context;Lbfq;)Z
    .locals 3
...
.method public static b(Landroid/content/Context;I)Lhww;
    .locals 2
...
.method public static b(Landroid/content/Context;ILjava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Lhwx;->e(Ljava/lang/String;)Lhwx;
...
.method public static b(Landroid/content/Context;ILjava/lang/String;J)V
    ...
    invoke-virtual {v0, p2, p3, p4}, Lhwx;->b(Ljava/lang/String;J)Lhwx;
...
.method public static b(Landroid/content/Context;Lbfq;)V
    .locals 6
    ...
    invoke-interface {v0, v1}, Lhwu;->a([Ljava/lang/String;)Ljava/util/List;
    ...
    .line 1080
    invoke-virtual {v1, v3, v4}, Lhwx;->b(Ljava/lang/String;Z)Lhwx;
...
.method public static b(Landroid/content/Context;Lbfq;J)V
    .locals 4
...
.method public static b(Landroid/content/Context;Lbfq;Z)V
    .locals 3
    ...
    .line 924
    invoke-static {p0, p1, p2}, Lbfs;->c(Landroid/content/Context;Lbfq;Z)V
...
.method public static c(Landroid/content/Context;Lbfq;)J
    .locals 4
...
.method public static c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .prologue
    .line 782
    invoke-static {p0, p1}, Lbfs;->b(Landroid/content/Context;I)Lhww;
...
.method public static c(Landroid/content/Context;Lbfq;J)V
    .locals 2
...
.method public static c(Landroid/content/Context;Lbfq;Z)V
    .locals 3
...
.method public static c(Landroid/content/Context;ILjava/lang/String;)[B
    ...
    invoke-interface {v0, p2}, Lhww;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public static d(Landroid/content/Context;Lbfq;)J
    .locals 4
...
.method public static d(Landroid/content/Context;I)Ldad;
    .locals 4
    ...
    invoke-direct {v0, v2, v1}, Ldad;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0
.end method

.method public static d(Landroid/content/Context;Lbfq;Z)V
    .locals 2
...
.method public static e(Landroid/content/Context;Lbfq;)J
    .locals 4
...
.method public static e(Landroid/content/Context;Lbfq;Z)V
    .locals 3
...
.method public static f(Landroid/content/Context;Lbfq;Z)V
    .locals 3
...
.method public a(I)V
    ...
    .line 544
    iget-object v0, p0, Lbfs;->b:Landroid/content/Context;
    ...
    invoke-interface {v1, v0}, Lhww;->c(Ljava/lang/String;)Z
    ...
    invoke-interface {v0, p1}, Lczj;->c(I)V
    ...
    invoke-static {v0, p1}, Lbhj;->b(Landroid/content/Context;I)V
    ...
    invoke-static {v0, v1}, Lbhj;->a(Landroid/content/Context;I)Lbhj;

    move-result-object v0

    .line 592
    invoke-virtual {v0}, Lbhj;->c()V
...
.method public a(Landroid/content/Context;Lhwz;)V
    ...
    .line 315
    invoke-interface {p2, v3, v0}, Lhwz;->c(Ljava/lang/String;Z)Lhwz;
...
.method public a(Ljava/util/List;)V
    ...
    .line 337
    iget-object v3, p0, Lbfs;->b:Landroid/content/Context;
    ...
    .line 3244
    invoke-static {v3, v0}, Lbfs;->a(Landroid/content/Context;[Ljava/lang/Integer;)V
    ...
    .line 3265
    invoke-static {v4}, Lbfs;->a(Landroid/content/SharedPreferences;)[Ljava/lang/Integer;
    ...
    .line 3277
    invoke-static {v3, v4}, Lbfs;->a(Landroid/content/Context;[Ljava/lang/Integer;)V

    .line 342
    new-instance v0, Lbfu;

    invoke-direct {v0, p0}, Lbfu;-><init>(Lbfs;)V
    ...
    invoke-direct {v0, p0}, Lbfv;-><init>(Lbfs;)V
    ...
    invoke-direct {v0, p0}, Lbfw;-><init>(Lbfs;)V
    ...
    invoke-direct {v0, p0}, Lbfx;-><init>(Lbfs;)V
    ...
    invoke-direct {v0, p0}, Lbfy;-><init>(Lbfs;)V
    ...
    invoke-direct {v0, p0}, Lbfz;-><init>(Lbfs;)V
    ...
    invoke-direct {v0, p0}, Lbga;-><init>(Lbfs;)V
