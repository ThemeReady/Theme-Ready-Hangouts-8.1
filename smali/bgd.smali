...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbgd;->q:Ljava/util/Map;
...
.method public static a(Lbfb;)Landroid/graphics/Bitmap;
    .locals 5

    .prologue
    .line 111
    sget-object v0, Lbgd;->q:Ljava/util/Map;
    ...
    .line 112
    sget-object v2, Lbgd;->q:Ljava/util/Map;
    ...
    .line 2125
    sget-object v0, Lbge;->a:[I

    invoke-virtual {p0}, Lbfb;->ordinal()I
    ...
    .line 2127
    invoke-static {v3, v0}, Lbgd;->a(Landroid/graphics/Canvas;Landroid/graphics/Bitmap;)V
...
.method public static a(Lbfq;Ljava/util/List;Z)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v3, v5}, Lezl;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v4, v0, v7, v6, v7}, Lbif;-><init>(Lezl;Lbii;ZLjava/lang/Object;)V
    ...
    invoke-virtual {v0, v4}, Leka;->c(Leje;)V
...
.method public static a(Landroid/graphics/Bitmap;)Z
    ...
    sget-object v0, Lbgd;->g:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbgd;->h:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbgd;->i:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbgd;->j:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbgd;->k:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbgd;->l:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbgd;->m:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbgd;->n:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbgd;->o:Landroid/graphics/Bitmap;

    if-eq p0, v0, :cond_0

    sget-object v0, Lbgd;->p:Landroid/graphics/Bitmap;
...
.method public static b()Landroid/graphics/Bitmap;
    ...
    .line 84
    invoke-static {v0}, Lezm;->a(I)Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbgd;->g:Landroid/graphics/Bitmap;
...
.method public static c()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbgd;->h:Landroid/graphics/Bitmap;
...
.method public static e()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbgd;->i:Landroid/graphics/Bitmap;
...
.method public static f()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbgd;->j:Landroid/graphics/Bitmap;
...
.method public static g()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbgd;->k:Landroid/graphics/Bitmap;
...
.method public static h()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbgd;->l:Landroid/graphics/Bitmap;
...
.method public static i()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbgd;->m:Landroid/graphics/Bitmap;
...
.method public static j()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbgd;->n:Landroid/graphics/Bitmap;
...
.method public static k()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbgd;->o:Landroid/graphics/Bitmap;
...
.method public static l()Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lbgd;->p:Landroid/graphics/Bitmap;
