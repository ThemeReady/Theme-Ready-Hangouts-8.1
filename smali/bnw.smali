...
# static fields
.field private static final a:Lkzr;
...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/ListView;I)V
    ...
    .line 72
    iput-object p2, p0, Lbnw;->c:Landroid/widget/ListView;
...
# virtual methods
.method public a(Landroid/view/ContextMenu;Landroid/view/View;Landroid/view/ContextMenu$ContextMenuInfo;Landroid/view/MenuInflater;Lenm;)V
    .locals 9

    .prologue
    .line 83
    iget-object v0, p0, Lbnw;->c:Landroid/widget/ListView;
    ...
    .line 93
    invoke-virtual {v0}, Lcom/google/android/apps/hangouts/views/MessageListItemWrapperView;->c()Lcvo;
    ...
    .line 111
    iget-object v5, p0, Lbnw;->e:Lhdg;

    iget v6, p0, Lbnw;->d:I

    .line 112
    invoke-interface {v5, v6}, Lhdg;->a(I)Lhdc;
    ...
    .line 113
    invoke-interface {v5, v6}, Lhdc;->a(I)Lhdd;

    move-result-object v5

    .line 114
    invoke-virtual {v0}, Lcom/google/android/apps/hangouts/views/MessageListItemView;->C()Lenj;

    move-result-object v0

    invoke-virtual {v0}, Lenj;->ordinal()I
    ...
    invoke-interface {v5, v0}, Lhdd;->a(Ljava/lang/Integer;)Lhdd;
    ...
    invoke-static {v0}, Lbnw;->a([Landroid/text/style/URLSpan;)Ljava/util/Set;
    ...
    .line 1204
    invoke-static {v1}, Laat;->p(Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    .line 1206
    iget-object v1, p0, Lbnw;->b:Landroid/content/Context;
