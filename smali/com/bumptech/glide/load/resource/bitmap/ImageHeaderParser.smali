...
.method public constructor <init>(Ljava/io/InputStream;Lamr;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Lamr;

    .line 100
    new-instance v0, Lasg;

    invoke-direct {v0, p1}, Lasg;-><init>(Ljava/io/InputStream;)V

    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lasf;

    .line 101
    return-void
.end method

.method public constructor <init>(Ljava/nio/ByteBuffer;Lamr;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Lasd;-><init>(Ljava/nio/ByteBuffer;)V
...
.method private static a(Lase;)I
    .locals 10
    ...
    .line 288
    invoke-virtual {p0, v1}, Lase;->b(I)S
    ...
    .line 301
    :goto_0
    invoke-virtual {p0, v0}, Lase;->a(Ljava/nio/ByteOrder;)V

    .line 303
    const/16 v0, 0xa

    invoke-virtual {p0, v0}, Lase;->a(I)I
    ...
    .line 309
    invoke-virtual {p0, v3}, Lase;->b(I)S
    ...
    invoke-virtual {p0, v5}, Lase;->b(I)S
    ...
    invoke-virtual {p0, v6}, Lase;->a(I)I
...
.method private d()I
    ...
    .line 246
    :cond_0
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lasf;

    invoke-interface {v1}, Lasf;->b()S
    ...
    .line 269
    iget-object v3, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lasf;

    int-to-long v4, v1

    invoke-interface {v3, v4, v5}, Lasf;->a(J)J
...
.method public b()Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser$ImageType;
    ...
    .line 116
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lasf;

    invoke-interface {v0}, Lasf;->a()I
    ...
    invoke-interface {v0, v2, v3}, Lasf;->a(J)J

    .line 129
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lasf;

    invoke-interface {v0}, Lasf;->c()I
    ...
    invoke-interface {v0, v6, v7}, Lasf;->a(J)J
...
.method public c()I
    ...
    .line 193
    iget-object v2, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Lamr;

    invoke-virtual {v2, v1}, Lamr;->a(I)[B
    ...
    invoke-interface {v3, v2, v1}, Lasf;->a([BI)I
    ...
    :cond_4
    :goto_2
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Lamr;

    invoke-virtual {v1, v2}, Lamr;->a([B)V
    ...
    invoke-direct {v0, v2, v1}, Lase;-><init>([BI)V

    invoke-static {v0}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->a(Lase;)I
    :try_end_1
