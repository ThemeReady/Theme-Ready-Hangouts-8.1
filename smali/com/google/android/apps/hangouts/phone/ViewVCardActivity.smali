...
.method public constructor <init>()V
    ...
    iget-object v1, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->B:Liwe;

    invoke-direct {v0, p0, v1}, Lhxj;-><init>(Landroid/app/Activity;Live;)V

    iget-object v1, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->A:Lisf;
    ...
    iput-object v0, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->j:Lhwp;
    ...
    invoke-direct {v0, p0}, Ldla;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
    ...
    invoke-direct {v0, p0}, Ldkw;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
...
.method private a(Landroid/net/Uri;ILafz;ZLjava/util/List;)Z
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p2}, Lage;-><init>(I)V

    .line 564
    invoke-virtual {v1, p3}, Laga;->a(Lafz;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Lago; {:try_start_0 .. :try_end_0} :catch_4
    .catch Lagl; {:try_start_0 .. :try_end_0} :catch_6

    .line 567
    :try_start_1
    invoke-virtual {v1, v3}, Laga;->a(Ljava/io/InputStream;)V
    :try_end_1
    .catch Lagp; {:try_start_1 .. :try_end_1} :catch_2
    ...
    .catch Lago; {:try_start_2 .. :try_end_2} :catch_4
    .catch Lagl; {:try_start_2 .. :try_end_2} :catch_6
    ...
    .catch Lago; {:try_start_3 .. :try_end_3} :catch_4
    .catch Lagl; {:try_start_3 .. :try_end_3} :catch_6
    ...
    invoke-direct {v1, p2}, Lagf;-><init>(I)V
    ...
    invoke-virtual {v1, v3}, Laga;->a(Ljava/io/InputStream;)V
    :try_end_6
    .catch Lagp; {:try_start_6 .. :try_end_6} :catch_7
    ...
    .catch Lago; {:try_start_7 .. :try_end_7} :catch_4
    .catch Lagl; {:try_start_7 .. :try_end_7} :catch_6
    ...
    .catch Lago; {:try_start_8 .. :try_end_8} :catch_4
    .catch Lagl; {:try_start_8 .. :try_end_8} :catch_6
    ...
    .catch Lago; {:try_start_a .. :try_end_a} :catch_4
    .catch Lagl; {:try_start_a .. :try_end_a} :catch_6
    ...
    .catch Lago; {:try_start_b .. :try_end_b} :catch_4
    .catch Lagl; {:try_start_b .. :try_end_b} :catch_6
    ...
    invoke-direct {v1, v4}, Lagl;-><init>(Ljava/lang/String;)V
    ...
    .catch Lago; {:try_start_d .. :try_end_d} :catch_4
    .catch Lagl; {:try_start_d .. :try_end_d} :catch_6
...
.method public static synthetic a(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/net/Uri;ILafz;ZLjava/util/List;)Z
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->a(Landroid/net/Uri;ILafz;ZLjava/util/List;)Z
...
# virtual methods
.method public a(Lafd;Ljava/util/List;Ljava/util/List;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 153
    invoke-virtual {p1}, Lafd;->b()Ljava/lang/String;
    ...
    .line 3610
    iget-object v0, p1, Lafd;->a:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lafq;->b()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lafq;->d()Ljava/lang/String;
    ...
    .line 3614
    :cond_4
    iget-object v0, p1, Lafd;->b:Ljava/util/List;
    ...
    .line 3618
    :cond_8
    iget-object v0, p1, Lafd;->c:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lafs;->h()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lafs;->j()Ljava/lang/String;
    ...
    .line 222
    invoke-virtual {v0}, Lafs;->b()Ljava/lang/String;
    ...
    .line 226
    :cond_9
    invoke-virtual {v0}, Lafs;->c()Ljava/lang/String;
    ...
    .line 230
    :cond_a
    invoke-virtual {v0}, Lafs;->d()Ljava/lang/String;
    ...
    .line 234
    :cond_b
    invoke-virtual {v0}, Lafs;->e()Ljava/lang/String;
    ...
    .line 238
    :cond_c
    invoke-virtual {v0}, Lafs;->f()Ljava/lang/String;
    ...
    .line 242
    :cond_d
    invoke-virtual {v0}, Lafs;->g()Ljava/lang/String;
    ...
    .line 3626
    :cond_12
    iget-object v0, p1, Lafd;->e:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lafl;->b()Ljava/lang/String;
    ...
    .line 4622
    :cond_14
    iget-object v0, p1, Lafd;->d:Ljava/util/List;
    ...
    .line 4634
    :cond_17
    iget-object v0, p1, Lafd;->f:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lafv;->b()Ljava/lang/String;
    ...
    .line 6232
    iget-object v0, v0, Lafg;->a:Ljava/lang/String;
    ...
    .line 6606
    :cond_1a
    iget-object v0, p1, Lafd;->g:Ljava/util/List;
...
.method public a(Landroid/net/Uri;Lagh;)V
    .locals 6
    ...
    invoke-static {v0}, Lafc;->a(Ljava/lang/String;)I
    ...
    invoke-direct {v3, v2, v1}, Lafw;-><init>(ILandroid/accounts/Account;)V
    ...
    invoke-direct {v0, p0, v1}, Lafy;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/os/Handler;)V

    invoke-virtual {v3, v0}, Lafw;->a(Lafy;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->a(Landroid/net/Uri;ILafz;ZLjava/util/List;)Z
    :try_end_0
    .catch Lagn; {:try_start_0 .. :try_end_0} :catch_0
...
.method public b(I)Landroid/net/Uri;
    ...
    .line 446
    sget-object v0, Lcat;->bz:Ljava/util/Random;
    ...
    invoke-static {v4, v5, v0}, Lfaq;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
    ...
    invoke-static {v3, v4, v0}, Lfaq;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v2, p0, v0}, Ldky;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/net/Uri;)V
    ...
    .line 135
    :goto_1
    invoke-virtual {p0}, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->g()Lqh;

    move-result-object v0

    .line 136
    invoke-virtual {v0, v4}, Lqh;->a(Z)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    iget-object v0, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->j:Lhwp;
    ...
    invoke-direct {v0, p0}, Ldkx;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
    ...
    .line 7436
    invoke-virtual {v0, v1}, Ldkx;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
