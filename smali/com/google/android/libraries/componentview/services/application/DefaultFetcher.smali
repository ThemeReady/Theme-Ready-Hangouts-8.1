...
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 46
    invoke-static {p2}, Laat;->a(Ljava/util/concurrent/ExecutorService;)Lliz;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/libraries/componentview/services/application/DefaultFetcher;->b:Lliz;
...
.method public a(Ljava/net/URI;[BZ)Llix;
    .locals 4
    ...
    .prologue
    .line 61
    iget-object v0, p0, Lcom/google/android/libraries/componentview/services/application/DefaultFetcher;->b:Lliz;

    new-instance v1, Lcom/google/android/libraries/componentview/services/application/DefaultFetcher$1;

    const/4 v2, 0x0

    invoke-direct {v1, p0, p1, v2, p3}, Lcom/google/android/libraries/componentview/services/application/DefaultFetcher$1;-><init>(Lcom/google/android/libraries/componentview/services/application/DefaultFetcher;Ljava/net/URI;[BZ)V

    .line 62
    invoke-interface {v0, v1}, Lliz;->a(Ljava/util/concurrent/Callable;)Llix;
    ...
    iget-object v3, p0, Lcom/google/android/libraries/componentview/services/application/DefaultFetcher;->b:Lliz;

    invoke-static {v0, v1, v2, v3}, Lliq;->a(Llix;Ljava/lang/Class;Llil;Ljava/util/concurrent/Executor;)Llix;
...
.method b(Ljava/net/URI;[BZ)Lcom/google/android/libraries/componentview/services/application/Fetcher$Response;
    .locals 12
    ...
    :goto_1
    :try_start_1
    invoke-static {v2}, Llgo;->a(Ljava/io/InputStream;)[B
