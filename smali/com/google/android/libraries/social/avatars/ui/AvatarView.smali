...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sput-object v0, Lcom/google/android/libraries/social/avatars/ui/AvatarView;->c:Libv;
...
.method private a(I)V
    ...
    invoke-static {v0}, Laat;->K(Landroid/content/Context;)I
    ...
    invoke-static {v0}, Laat;->G(Landroid/content/Context;)I
    ...
    invoke-static {v0}, Laat;->I(Landroid/content/Context;)I
    ...
    invoke-static {v0}, Laat;->M(Landroid/content/Context;)I
...
.method public a()V
    ...
    .line 248
    sget-object v0, Lcom/google/android/libraries/social/avatars/ui/AvatarView;->c:Libv;
    ...
    invoke-interface/range {v0 .. v5}, Libv;->a(Landroid/content/Context;Ljava/lang/String;IILino;)Linm;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/libraries/social/avatars/ui/AvatarView;->k:Linm;
...
.method public a(Linm;)V
    ...
    .line 271
    invoke-virtual {p1}, Linm;->o()Ljava/lang/Object;
...
.method public b()V
    ...
    .prologue
    .line 262
    iget-object v0, p0, Lcom/google/android/libraries/social/avatars/ui/AvatarView;->k:Linm;
    ...
    invoke-virtual {v0, p0}, Linm;->b(Lino;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 362
    iget-object v1, p0, Lcom/google/android/libraries/social/avatars/ui/AvatarView;->k:Linm;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/google/android/libraries/social/avatars/ui/AvatarView;->k:Linm;

    invoke-virtual {v1}, Linm;->m()I
    ...
    invoke-virtual {v0}, Linm;->o()Ljava/lang/Object;
    ...
    .line 3115
    invoke-static {v0}, Laat;->H(Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    .line 3102
    :pswitch_1
    sget-object v1, Laat;->uz:Landroid/graphics/Bitmap;
    ...
    sput-object v0, Laat;->uz:Landroid/graphics/Bitmap;

    .line 3106
    :cond_6
    sget-object v0, Laat;->uz:Landroid/graphics/Bitmap;

    goto :goto_0

    .line 3108
    :pswitch_2
    sget-object v1, Laat;->uA:Landroid/graphics/Bitmap;
    ...
    invoke-static {v0}, Laat;->O(Landroid/content/Context;)F

    move-result v0

    .line 3109
    invoke-static {v1, v0}, Lirv;->a(Landroid/graphics/Bitmap;F)Landroid/graphics/Bitmap;

    move-result-object v0

    sput-object v0, Laat;->uA:Landroid/graphics/Bitmap;

    .line 3112
    :cond_7
    sget-object v0, Laat;->uA:Landroid/graphics/Bitmap;
    ...
    .line 3166
    invoke-static {v0}, Laat;->J(Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    .line 3153
    :pswitch_4
    sget-object v1, Laat;->uC:Landroid/graphics/Bitmap;
    ...
    sput-object v0, Laat;->uC:Landroid/graphics/Bitmap;

    .line 3157
    :cond_8
    sget-object v0, Laat;->uC:Landroid/graphics/Bitmap;

    goto/16 :goto_0

    .line 3159
    :pswitch_5
    sget-object v1, Laat;->uD:Landroid/graphics/Bitmap;
    ...
    sput-object v0, Laat;->uD:Landroid/graphics/Bitmap;

    .line 3163
    :cond_9
    sget-object v0, Laat;->uD:Landroid/graphics/Bitmap;
    ...
    .line 3217
    invoke-static {v0}, Laat;->L(Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    .line 3204
    :pswitch_7
    sget-object v1, Laat;->uF:Landroid/graphics/Bitmap;
    ...
    sput-object v0, Laat;->uF:Landroid/graphics/Bitmap;

    .line 3208
    :cond_a
    sget-object v0, Laat;->uF:Landroid/graphics/Bitmap;

    goto/16 :goto_0

    .line 3210
    :pswitch_8
    sget-object v1, Laat;->uG:Landroid/graphics/Bitmap;
    ...
    sput-object v0, Laat;->uG:Landroid/graphics/Bitmap;

    .line 3214
    :cond_b
    sget-object v0, Laat;->uG:Landroid/graphics/Bitmap;
    ...
    .line 3269
    invoke-static {v0}, Laat;->N(Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    .line 3256
    :pswitch_a
    sget-object v1, Laat;->uI:Landroid/graphics/Bitmap;
    ...
    sput-object v0, Laat;->uI:Landroid/graphics/Bitmap;

    .line 3260
    :cond_c
    sget-object v0, Laat;->uI:Landroid/graphics/Bitmap;

    goto/16 :goto_0

    .line 3262
    :pswitch_b
    sget-object v1, Laat;->uJ:Landroid/graphics/Bitmap;
    ...
    sput-object v0, Laat;->uJ:Landroid/graphics/Bitmap;

    .line 3266
    :cond_d
    sget-object v0, Laat;->uJ:Landroid/graphics/Bitmap;
