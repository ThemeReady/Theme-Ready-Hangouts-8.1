...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcwp;->d:Ljava/util/concurrent/locks/ReadWriteLock;

    .line 3056
    iget-object v0, p0, Lcwp;->d:Ljava/util/concurrent/locks/ReadWriteLock;

    invoke-interface {v0}, Ljava/util/concurrent/locks/ReadWriteLock;->readLock()Ljava/util/concurrent/locks/Lock;

    move-result-object v0

    iput-object v0, p0, Lcwp;->e:Ljava/util/concurrent/locks/Lock;
    ...
    iput-object v0, p0, Lcwp;->f:Ljava/util/concurrent/locks/Lock;
    ...
    iput-object v0, p0, Lcwp;->b:Ljava/util/Map;
    ...
    iput-object v0, p0, Lcwp;->c:Ljava/util/Map;
...
.method public a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0}, Lcwp;->a(Ljava/lang/String;Z)Ljava/lang/String;
...
.method a(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    .prologue
    .line 3077
    iget-object v0, p0, Lcwp;->f:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v0}, Ljava/util/concurrent/locks/Lock;->lock()V

    .line 3080
    :try_start_0
    iget-object v0, p0, Lcwp;->c:Ljava/util/Map;
    ...
    .line 3084
    iget-object v0, p0, Lcwp;->a:Ljava/lang/String;

    const/4 v1, 0x0

    invoke-static {p1, v0, v1}, Laat;->a(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    .line 3087
    iget-object v0, p0, Lcwp;->b:Ljava/util/Map;
    ...
    .line 4170
    invoke-static {v0, v1}, Lfhs;->a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 3106
    iget-object v3, p0, Lcwp;->b:Ljava/util/Map;
    ...
    .catch Leyg; {:try_start_0 .. :try_end_0} :catch_3
    .catch Leyf; {:try_start_0 .. :try_end_0} :catch_6
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_5
    .catch Lgzk; {:try_start_0 .. :try_end_0} :catch_7
    .catch Lgzj; {:try_start_0 .. :try_end_0} :catch_4
    ...
    .line 3138
    :cond_3
    iget-object v1, p0, Lcwp;->f:Ljava/util/concurrent/locks/Lock;
...
.method public b(Ljava/lang/String;)V
    ...
    invoke-static {p1, v0, v1}, Laat;->a(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    :try_end_0
    .catch Leyf; {:try_start_0 .. :try_end_0} :catch_0
    .catch Lgzj; {:try_start_0 .. :try_end_0} :catch_1
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_6
    .catch Lgzk; {:try_start_0 .. :try_end_0} :catch_7
    .catch Landroid/accounts/AuthenticatorException; {:try_start_0 .. :try_end_0} :catch_2
    .catch Landroid/accounts/OperationCanceledException; {:try_start_0 .. :try_end_0} :catch_3
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_4
    .catch Leyg; {:try_start_0 .. :try_end_0} :catch_5
...
.method public c(Ljava/lang/String;)Ljava/lang/Long;
    ...
    .prologue
    .line 2067
    iget-object v0, p0, Lcwp;->e:Ljava/util/concurrent/locks/Lock;
    ...
    .line 2071
    iget-object v1, p0, Lcwp;->e:Ljava/util/concurrent/locks/Lock;
