...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lczd;->o:Ljava/util/Set;
    ...
    sput-object v0, Lczd;->b:Ljava/util/Map;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;ILeyv;)V
    .locals 3
    ...
    iput-object v0, p0, Lczd;->s:Ljava/util/HashSet;
    ...
    iput-object v0, p0, Lczd;->h:Ljava/util/List;
    ...
    iput-object v0, p0, Lczd;->i:Ljava/util/List;
    ...
    iput-object v0, p0, Lczd;->x:Ljava/util/Set;

    .line 391
    iput-object p1, p0, Lczd;->p:Landroid/content/Context;

    .line 392
    iput p2, p0, Lczd;->q:I

    .line 393
    iput-object p3, p0, Lczd;->r:Leyv;

    .line 395
    sget-object v1, Lczd;->o:Ljava/util/Set;

    monitor-enter v1

    .line 397
    :try_start_0
    invoke-virtual {p0}, Lczd;->j()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0}, Lczd;->e()I
    ...
    .line 398
    sget-object v0, Lczd;->o:Ljava/util/Set;
    ...
    iput-object v0, p0, Lczd;->w:Lcy;

    .line 405
    iget-object v0, p0, Lczd;->w:Lcy;

    invoke-virtual {p0}, Lczd;->d()I
...
.method private a(Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/String;II)Ljava/lang/CharSequence;
    ...
    .line 342
    iget-object v1, p0, Lczd;->p:Landroid/content/Context;
    ...
    .line 351
    :cond_3
    invoke-virtual {p0, p4}, Lczd;->a(I)Ljava/lang/CharSequence;
...
.method private a(Ljava/lang/String;)V
    ...
    .prologue
    .line 207
    iget-object v0, p0, Lczd;->i:Ljava/util/List;
    ...
    .line 208
    invoke-virtual {v0}, Lbfh;->a()Ljava/lang/String;
    ...
    .line 215
    invoke-virtual {v0, p1}, Lbgm;->Y(Ljava/lang/String;)Ljava/util/List;

    move-result-object v0

    .line 216
    iget-object v1, p0, Lczd;->i:Ljava/util/List;
    ...
    iget-object v3, v0, Lbgq;->s:Ljava/lang/String;

    .line 220
    invoke-static {v2, v3}, Lbfh;->c(Lbfq;Ljava/lang/String;)Lbfh;
...
.method protected static a(Ljava/lang/String;I)V
    ...
    .line 264
    sget-object v2, Lczd;->o:Ljava/util/Set;
    ...
    .line 266
    invoke-virtual {v0}, Lczd;->j()Ljava/lang/String;
...
.method protected a(I)Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Lczd;->p:Landroid/content/Context;
    ...
    :goto_0
    :pswitch_0
    iget-object v3, p0, Lczd;->p:Landroid/content/Context;
...
.method public a(Z)V
    ...
    .line 1154
    invoke-virtual {p0}, Lczd;->o()Lemb;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lelx;->b(ILemb;)Ljava/lang/String;
    ...
    .line 1157
    invoke-virtual {p0}, Lczd;->l()Ljava/lang/String;
    ...
    .line 1155
    invoke-static {v1, v2}, Lfab;->a(Landroid/net/Uri;[Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 423
    :goto_0
    invoke-static {v1, v3, v4, v0}, Lezz;->a(IIILjava/lang/String;)I
    ...
    .line 430
    invoke-virtual {p0}, Lczd;->b()Landroid/content/Intent;
    ...
    .line 2561
    sget-object v0, Lczd;->b:Ljava/util/Map;
    ...
    invoke-static {v3, v4, v5}, Laat;->a(Landroid/content/Context;Ljava/lang/String;I)I
    ...
    .line 3589
    invoke-virtual {p0}, Lczd;->g()Landroid/content/Intent;
    ...
    invoke-static {v0, v2}, Leyh;->a(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    .line 3598
    invoke-virtual {v0, v2}, Leo;->b(Landroid/content/Intent;)Leo;
    ...
    .line 3602
    invoke-virtual {v3, v0}, Leo;->a(I)Landroid/content/Intent;

    move-result-object v4

    .line 3603
    sget-object v5, Lczd;->a:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lcy;->d(Z)Lcy;
    ...
    .line 3618
    :goto_5
    invoke-virtual {v3, v2, v0}, Leo;->a(II)Landroid/app/PendingIntent;

    move-result-object v0

    .line 441
    invoke-virtual {v1, v0}, Lcy;->a(Landroid/app/PendingIntent;)Lcy;

    .line 442
    iget-object v0, p0, Lczd;->u:Lcy;

    invoke-virtual {p0}, Lczd;->f()I
    ...
    :cond_c
    :goto_6
    iget-object v0, p0, Lczd;->s:Ljava/util/HashSet;
    ...
    iget-object v3, p0, Lczd;->s:Ljava/util/HashSet;
    ...
    .line 464
    sget-object v0, Lczd;->d:Landroid/graphics/Bitmap;
    ...
    sput-object v0, Lczd;->d:Landroid/graphics/Bitmap;

    .line 468
    :cond_e
    iget-object v0, p0, Lczd;->v:Ldl;

    sget-object v1, Lczd;->d:Landroid/graphics/Bitmap;

    invoke-virtual {v0, v1}, Ldl;->a(Landroid/graphics/Bitmap;)Ldl;

    .line 474
    :cond_f
    iget-object v0, p0, Lczd;->h:Ljava/util/List;
    ...
    .line 479
    invoke-virtual {v12}, Lbfh;->f()Ljava/util/ArrayList;
    ...
    .line 482
    iget-object v3, v0, Lczz;->h:Ljava/lang/String;
    ...
    .line 486
    :cond_14
    invoke-virtual {v12}, Lbfh;->e()I

    move-result v0

    iget-object v1, p0, Lczd;->h:Ljava/util/List;
    ...
    .line 491
    invoke-static {v3, v4}, Lisf;->a(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v3, v4}, Lhwu;->a(I)Lhww;
    ...
    .line 4625
    invoke-direct {v6, p0}, Lczg;-><init>(Lczd;)V
    ...
    .line 5543
    iget-object v7, p0, Lczd;->p:Landroid/content/Context;

    const-class v10, Leqa;

    invoke-static {v7, v10}, Lisf;->a(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Leqa;

    invoke-interface {v7}, Leqa;->d()Z
    ...
    :goto_9
    invoke-virtual {v3, v0}, Lbif;->a(Z)V
    ...
    .line 505
    invoke-virtual {v13, v3}, Leka;->c(Leje;)V
    ...
    .line 7647
    invoke-direct {v6, p0}, Lczh;-><init>(Lczd;)V
    ...
    .line 520
    :cond_18
    invoke-virtual {v13, v1}, Leka;->c(Leje;)V

    .line 526
    :cond_19
    const/4 v0, 0x1

    iput-boolean v0, p0, Lczd;->e:Z

    .line 527
    invoke-virtual {p0}, Lczd;->u()V
    ...
    invoke-direct {v1, p0}, Lcze;-><init>(Lczd;)V
...
.method protected b(Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/String;I)Ljava/lang/CharSequence;
    ...
    invoke-direct/range {v0 .. v5}, Lczd;->a(Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/String;II)Ljava/lang/CharSequence;
...
.method protected b(Ljava/lang/String;)V
    ...
    .prologue
    .line 163
    invoke-direct {p0, p1}, Lczd;->a(Ljava/lang/String;)V
    ...
    .line 171
    iget-object v2, p0, Lczd;->h:Ljava/util/List;
...
.method public c(Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/String;I)Ljava/lang/CharSequence;
    .locals 6
...
.method protected c(Ljava/lang/String;)V
    ...
    .line 185
    iget-object v1, p0, Lczd;->s:Ljava/util/HashSet;
    ...
    invoke-interface {v1, v5}, Lddl;->a(Ljava/lang/String;)Z
    ...
    .line 192
    :cond_3
    iget-object v5, p0, Lczd;->p:Landroid/content/Context;
    ...
    invoke-interface {v1, v6}, Lhwu;->a(I)Lhww;
    ...
    .line 1000
    invoke-static {v5, v1, v0}, Lgpa;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)J

    move-result-wide v0

    invoke-static {v5, v0, v1}, Lgpa;->a(Landroid/content/Context;J)Landroid/net/Uri;
...
.method protected h()V
    ...
    invoke-virtual {v0, v8}, Lcy;->e(Z)Lcy;

    .line 697
    iget-object v0, p0, Lczd;->u:Lcy;

    iget-object v1, p0, Lczd;->w:Lcy;
...
.method protected j()Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lczd;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    iget-object v2, p0, Lczd;->r:Leyv;

    invoke-virtual {v2}, Leyv;->a()Ljava/lang/String;

    move-result-object v2

    invoke-static {v0, v1, v2}, Lczd;->a(Landroid/content/Context;ILjava/lang/String;)Ljava/lang/String;
...
.method protected final t()Landroid/app/PendingIntent;
    ...
    .line 8603
    sget-object v4, Lczd;->a:Ljava/lang/String;
...
.method u()V
    ...
    .prologue
    .line 664
    iget-object v1, p0, Lczd;->x:Ljava/util/Set;

    monitor-enter v1

    .line 665
    :try_start_0
    iget-object v0, p0, Lczd;->x:Ljava/util/Set;
...
.method v()V
    ...
    iget-boolean v0, p0, Lczd;->g:Z

    if-nez v0, :cond_0

    .line 678
    invoke-virtual {p0}, Lczd;->h()V
