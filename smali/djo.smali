...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldjo;->a:Lfbd;

    return-void
.end method

.method constructor <init>(Landroid/content/Context;Lcrp;)V
    .locals 1
    ...
    .line 71
    iput-object p1, p0, Ldjo;->b:Landroid/content/Context;

    .line 72
    const/16 v0, 0x11

    invoke-interface {p2, v0}, Lcrp;->a(I)Lcro;

    move-result-object v0

    iput-object v0, p0, Ldjo;->c:Lcro;
...
.method public a()V
    ...
    .line 81
    iget-object v1, p0, Ldjo;->b:Landroid/content/Context;
    ...
    .line 91
    iget-object v0, p0, Ldjo;->b:Landroid/content/Context;

    invoke-static {v0}, Laat;->i(Landroid/content/Context;)V
    ...
    invoke-static {v0, v1, v6}, Lfaq;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v6, v0}, Lisf;->a(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-direct {v7, v1}, Ldjs;-><init>(Landroid/content/Context;)V

    invoke-interface {v0, v7}, Layk;->a(Ljava/lang/Runnable;)V

    .line 148
    const-class v1, Lden;

    invoke-virtual {v6, v1}, Lisf;->c(Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 150
    iget-object v8, p0, Ldjo;->b:Landroid/content/Context;

    invoke-interface {v1, v8, v0}, Lden;->a(Landroid/content/Context;Layk;)V
    ...
    invoke-static {v1, v6, v0}, Lfaq;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0}, Laat;->f(Landroid/content/Context;)Z
    ...
    .line 4207
    new-instance v7, Leof;

    invoke-direct {v7}, Leof;-><init>()V

    .line 5019
    sput-object v7, Laer;->a:Laer;

    .line 4209
    new-instance v7, Leog;

    invoke-direct {v7, v1}, Leog;-><init>(Landroid/content/Context;)V

    .line 4219
    invoke-virtual {v7}, Leog;->start()V

    .line 164
    invoke-static {}, Lenq;->a()V
    ...
    invoke-direct {v7, p0}, Ldjp;-><init>(Ldjo;)V

    .line 170
    invoke-interface {v1, v7}, Lbec;->a(Ljava/lang/Runnable;)V

    .line 177
    invoke-virtual {p0}, Ldjo;->b()V

    .line 179
    new-instance v1, Ldjy;

    iget-object v7, p0, Ldjo;->b:Landroid/content/Context;

    invoke-direct {v1, v7, v0}, Ldjy;-><init>(Landroid/content/Context;Z)V

    .line 184
    iget-object v0, p0, Ldjo;->b:Landroid/content/Context;

    invoke-static {v0}, Litx;->a(Landroid/content/Context;)Z
    ...
    invoke-virtual {v6, v0}, Lisf;->c(Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-static {v0, v8, v9}, Lfaq;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v6, v0}, Lisf;->b(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-direct {v1, p0}, Ldjq;-><init>(Ldjo;)V
    ...
    invoke-static {v1, v0, v2}, Laat;->a(Landroid/content/Context;Ljava/lang/String;Z)Z
    ...
    invoke-interface {v0, v4, v5, v2, v3}, Laym;->a(JJ)V
...
.method b()V
    ...
    .line 251
    invoke-interface {v3, v4, v2}, Lbec;->a(Ljava/lang/String;Z)Z
    ...
    .line 256
    invoke-interface {v3, v5, v1}, Lbec;->a(Ljava/lang/String;Z)Z
    ...
    .line 5129
    :goto_0
    sput-boolean v4, Lhdy;->a:Z

    .line 5130
    sput-boolean v0, Lhdy;->b:Z

    .line 266
    invoke-static {}, Lfaq;->a()V
