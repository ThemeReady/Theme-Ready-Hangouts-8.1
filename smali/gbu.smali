...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object p1, p0, Lgbu;->d:Landroid/content/Context;

    new-instance v0, Lgbx;

    iget-object v2, p0, Lgbu;->d:Landroid/content/Context;

    invoke-direct {v0, v2}, Lgbx;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lgbu;->f:Lgbx;

    if-eqz p2, :cond_2

    invoke-direct {p0}, Lgbu;->a()Ljavax/net/ssl/SSLSocketFactory;

    move-result-object v0

    :goto_0
    iput-object v0, p0, Lgbu;->c:Ljavax/net/ssl/SSLSocketFactory;

    iget-object v0, p0, Lgbu;->c:Ljavax/net/ssl/SSLSocketFactory;
    ...
    iput-object v0, p0, Lgbu;->e:Ljavax/net/ssl/HostnameVerifier;
...
.method private a()Ljavax/net/ssl/SSLSocketFactory;
    ...
    :try_start_0
    iget-object v0, p0, Lgbu;->d:Landroid/content/Context;

    invoke-static {v0}, Lfja;->d(Landroid/content/Context;)Landroid/content/Context;
    ...
    iget-object v5, p0, Lgbu;->d:Landroid/content/Context;
...
.method public a(Ljava/net/URL;Landroid/net/Network;)Ljava/net/HttpURLConnection;
    ...
    iget-object v0, p0, Lgbu;->f:Lgbx;

    invoke-virtual {p1}, Ljava/net/URL;->toString()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lgbx;->a(Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-direct {v1, v0}, Lasj;-><init>(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lgbu;->c:Ljavax/net/ssl/SSLSocketFactory;

    invoke-virtual {v0, v2}, Ljavax/net/ssl/HttpsURLConnection;->setSSLSocketFactory(Ljavax/net/ssl/SSLSocketFactory;)V

    :cond_4
    iget-object v0, p0, Lgbu;->e:Ljavax/net/ssl/HostnameVerifier;
    ...
    iget-object v2, p0, Lgbu;->e:Ljavax/net/ssl/HostnameVerifier;
...
.method a(Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, p1, p2}, Lgbx;->a(Ljava/lang/String;I)V
