...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgpq;->a:[Ljava/lang/String;

    sput-boolean v3, Lgpq;->b:Z

    sput-boolean v3, Lgpq;->c:Z
...
.method public static final a(Lgrh;)V
    .locals 1

    const-string v0, "(mimetype IN (\'vnd.android.cursor.item/email_v2\',\'vnd.android.cursor.item/phone_v2\'))"

    invoke-virtual {p0, v0}, Lgrh;->b(Ljava/lang/String;)V

    return-void
.end method

.method public static final a(Lgrh;ZLandroid/content/Context;)V
    .locals 2
    ...
    invoke-static {p2}, Lgpq;->a(Landroid/content/Context;)Z
...
.method private static final declared-synchronized a(Landroid/content/Context;)Z
    .locals 8
    ...
    :try_start_0
    sget-boolean v0, Lgpq;->c:Z

    if-eqz v0, :cond_0

    sget-boolean v0, Lgpq;->b:Z
    :try_end_0
    ...
    const-string v2, "Error occurred when checking for default_directory table."
