...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgpz;->o:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lgpx;ZILandroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v7}, Lgpt;-><init>(Landroid/content/Context;Lgpx;ZILandroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)V

    iput-object p7, p0, Lgpz;->p:Ljava/lang/String;
...
.method protected a(Lgpw;Lgpw;Landroid/database/Cursor;)Lgpl;
    ...
    iget-object v3, p0, Lgpz;->i:Lgri;

    const-string v4, "people-map start"

    invoke-virtual {v3, v4}, Lgri;->a(Ljava/lang/String;)V

    invoke-static {p1, v2}, Lgpz;->a(Lgpw;Ljava/util/HashMap;)V
    ...
    invoke-direct {v3}, Lgrk;-><init>()V

    new-instance v4, Lgqk;

    invoke-direct {v4}, Lgqk;-><init>()V

    new-instance v8, Ljava/util/HashMap;

    invoke-direct {v8}, Ljava/util/HashMap;-><init>()V

    invoke-virtual {p0, p2, v8}, Lgpz;->b(Lgpw;Ljava/util/HashMap;)V

    iget-object v7, p0, Lgpz;->i:Lgri;

    const-string v9, "contact-map start"

    invoke-virtual {v7, v9}, Lgri;->a(Ljava/lang/String;)V

    invoke-virtual {p0, p3, v3, v4, v8}, Lgpz;->a(Landroid/database/Cursor;Lgrk;Lgqk;Ljava/util/HashMap;)I

    move-result v7

    iget-object v9, p0, Lgpz;->i:Lgri;

    const-string v10, "contact-map finish"

    invoke-virtual {v9, v10}, Lgri;->a(Ljava/lang/String;)V

    .line 2000
    invoke-static {v11}, Laat;->q(I)Z
    ...
    .line 0
    :cond_0
    iget-object v0, p0, Lgpz;->i:Lgri;

    const-string v7, "merge start"

    invoke-virtual {v0, v7}, Lgri;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v9}, Lgpw;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v5, v0}, Lgql;->a(I)V

    invoke-virtual {v7, v9}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    if-eqz v9, :cond_1

    invoke-virtual {v3, v9}, Lgrk;->a(Ljava/lang/String;)I
    ...
    :cond_2
    invoke-virtual {v6, v3, v9}, Lgql;->a(Lgrk;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v3}, Lgqk;->a(I)I
    ...
    invoke-virtual {v6, v3}, Lgql;->a(I)V
    ...
    invoke-virtual {v4, v3, v0}, Lgqk;->a(II)Ljava/lang/String;
    ...
    iget-object v3, p0, Lgpz;->a:Landroid/content/Context;
    ...
    iget-object v10, p0, Lgpz;->f:Landroid/os/Bundle;
...
.method protected c()Landroid/database/Cursor;
    ...
    sget-object v0, Lgpr;->b:Landroid/net/Uri;

    invoke-virtual {v0}, Landroid/net/Uri;->buildUpon()Landroid/net/Uri$Builder;

    move-result-object v0

    iget-object v1, p0, Lgpz;->p:Ljava/lang/String;
    ...
    iget-object v0, p0, Lgpz;->a:Landroid/content/Context;
    ...
    invoke-direct {v8}, Lgrh;-><init>()V

    iget-boolean v0, p0, Lgpz;->c:Z

    iget-object v1, p0, Lgpz;->a:Landroid/content/Context;

    invoke-static {v8, v0, v1}, Lgpq;->a(Lgrh;ZLandroid/content/Context;)V

    invoke-static {v8}, Lgpq;->a(Lgrh;)V
    ...
    sget-object v2, Lgpz;->o:[Ljava/lang/String;
    ...
    invoke-direct {v1, v9, v10}, Lgqa;-><init>(Landroid/database/Cursor;I)V

    new-instance v2, Lgqa;

    invoke-direct {v2, v0, v10}, Lgqa;-><init>(Landroid/database/Cursor;I)V
    ...
    invoke-virtual {v8, v0}, Lgrh;->b(Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v0}, Lgrh;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v8}, Lgrh;->toString()Ljava/lang/String;
