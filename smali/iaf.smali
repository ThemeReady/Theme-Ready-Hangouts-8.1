...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Liaf;->b:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, Liaf;->c:Ljava/util/Map;
    ...
    iput-object v0, p0, Liaf;->d:Ljava/util/Map;

    .line 95
    iget-object v0, p0, Liaf;->c:Ljava/util/Map;

    const-string v1, "position"

    new-array v2, v6, [Landroid/util/Property;

    sget-object v3, Lial;->e:Landroid/util/Property;

    aput-object v3, v2, v4

    sget-object v3, Lial;->f:Landroid/util/Property;
    ...
    .line 97
    iget-object v0, p0, Liaf;->d:Ljava/util/Map;
...
.method private static a(Liag;Landroid/util/Property;D)F
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 389
    invoke-virtual {p0, p1}, Liag;->a(Landroid/util/Property;)Z
    ...
    invoke-direct {v0, v1}, Liah;-><init>(Ljava/lang/String;)V
    ...
    .line 393
    sget-object v1, Lial;->e:Landroid/util/Property;
    ...
    .line 395
    :cond_2
    sget-object v1, Lial;->f:Landroid/util/Property;
...
.method private a(Landroid/content/Context;ILjava/util/Map;FF)Landroid/animation/Animator;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v6}, Liag;-><init>(Liaf;Landroid/content/Context;ILjava/util/Map;FF)V
    ...
    .line 161
    invoke-direct {p0, v0}, Liaf;->b(Liag;)Ljava/util/Collection;
    ...
    invoke-direct {v2, p0, v0}, Liai;-><init>(Liaf;Liag;)V
    ...
    invoke-direct {v1, v0}, Liah;-><init>(Ljava/lang/Throwable;)V
...
.method private a(Liag;Lorg/json/JSONObject;Ljava/util/Collection;)V
    .locals 26
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v2, v0, Liag;->d:Ljava/util/Map;
    ...
    iget-object v2, v0, Liaf;->c:Ljava/util/Map;
    ...
    iget-object v4, v0, Liaf;->d:Ljava/util/Map;
    ...
    invoke-static {v0, v1, v8, v9}, Liaf;->a(Liag;Landroid/util/Property;D)F
    ...
    invoke-interface {v11, v7, v8}, Liak;->a(Landroid/animation/Keyframe;Landroid/animation/Keyframe;)V
    ...
    invoke-direct {v7, v9, v11, v0, v8}, Liaj;-><init>(FFFF)V
...
.method private b(Liag;)Ljava/util/Collection;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 300
    iget-object v0, p1, Liag;->c:Lorg/json/JSONObject;
    ...
    invoke-direct {p0, p1, v4, v2}, Liaf;->a(Liag;Lorg/json/JSONObject;Ljava/util/Collection;)V
...
.method public a(Landroid/content/Context;ILjava/util/Map;)Landroid/animation/Animator;
    ...
    .line 122
    invoke-direct/range {v0 .. v5}, Liaf;->a(Landroid/content/Context;ILjava/util/Map;FF)Landroid/animation/Animator;
...
.method a(Liag;)V
    ...
    .line 257
    iget-object v1, p1, Liag;->d:Ljava/util/Map;
    ...
    .line 1275
    iget-object v1, p0, Liaf;->d:Ljava/util/Map;
    ...
    .line 1278
    iget-object v1, p0, Liaf;->c:Ljava/util/Map;
    ...
    .line 1280
    iget-object v2, p0, Liaf;->d:Ljava/util/Map;
    ...
    invoke-virtual {p1, v9}, Liag;->a(Landroid/util/Property;)Z
    ...
    .line 1282
    invoke-static {p1, v1, v10, v11}, Liaf;->a(Liag;Landroid/util/Property;D)F
    ...
    invoke-virtual {p1, v10}, Liag;->a(Landroid/util/Property;)Z
    ...
    .line 1288
    invoke-static {p1, v11, v12, v13}, Liaf;->a(Liag;Landroid/util/Property;D)F
