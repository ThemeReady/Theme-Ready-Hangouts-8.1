...
# direct methods
.method public constructor <init>(Ljava/nio/channels/WritableByteChannel;Lilx;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;",
    ...
    .line 17
    iput-object p1, p0, Limd;->b:Ljava/nio/channels/WritableByteChannel;

    .line 18
    new-instance v0, Lily;

    invoke-direct {v0, p2}, Lily;-><init>(Lilx;)V

    iput-object v0, p0, Limd;->a:Lily;
...
.method public a()Ljava/nio/channels/WritableByteChannel;
    ...
    .prologue
    .line 43
    iget-object v0, p0, Limd;->b:Ljava/nio/channels/WritableByteChannel;
...
.method public a(J)V
    ...
    invoke-virtual {v0, p1, p2}, Lily;->a(J)V
