...
.field final synthetic c:Lgzn;

.field final synthetic d:Lcom/google/android/libraries/social/silentfeedback/impl/SilentFeedbackService;


# direct methods
.method public constructor <init>(Lcom/google/android/libraries/social/silentfeedback/impl/SilentFeedbackService;Lhau;Landroid/content/Intent;Lgzn;)V
    .locals 0

    .prologue
    .line 140
    iput-object p1, p0, Lirl;->d:Lcom/google/android/libraries/social/silentfeedback/impl/SilentFeedbackService;

    iput-object p2, p0, Lirl;->a:Lhau;

    iput-object p3, p0, Lirl;->b:Landroid/content/Intent;

    iput-object p4, p0, Lirl;->c:Lgzn;
...
.method public a()V
    ...
    .line 147
    :try_start_0
    iget-object v1, p0, Lirl;->a:Lhau;

    iget-object v0, p0, Lirl;->d:Lcom/google/android/libraries/social/silentfeedback/impl/SilentFeedbackService;

    iget-object v2, p0, Lirl;->b:Landroid/content/Intent;
    ...
    invoke-interface {v0, v3}, Lhaz;->b(Ljava/lang/String;)Lhay;

    .line 1051
    const/4 v3, 0x1

    invoke-interface {v0, v3}, Lhaz;->a(Z)Lhay;
    ...
    invoke-interface {v0, v3}, Lhaz;->d(Ljava/lang/String;)Lhaz;
    ...
    invoke-interface {v0, v3}, Lhaz;->h(Ljava/lang/String;)Lhaz;
    ...
    invoke-interface {v0, v3}, Lhaz;->f(Ljava/lang/String;)Lhaz;
    ...
    invoke-interface {v0, v3}, Lhaz;->e(Ljava/lang/String;)Lhaz;
    ...
    invoke-interface {v0, v3}, Lhaz;->a(I)Lhaz;
    ...
    invoke-interface {v0, v3}, Lhaz;->g(Ljava/lang/String;)Lhaz;
    ...
    invoke-interface {v0, v2}, Lhaz;->c(Ljava/lang/String;)Lhay;

    .line 1073
    :cond_6
    invoke-interface {v0}, Lhaz;->a()Lhax;

    move-result-object v0

    .line 147
    invoke-virtual {v1, v0}, Lhau;->a(Lhax;)Lgzs;

    move-result-object v0

    new-instance v1, Lirm;

    invoke-direct {v1, p0}, Lirm;-><init>(Lirl;)V
