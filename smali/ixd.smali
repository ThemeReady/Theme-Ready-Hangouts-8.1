...
# instance fields
.field final transient a:Liwy;


# direct methods
.method private constructor <init>(Lcom/google/api/client/http/HttpResponseException$Builder;Liwy;)V
    .locals 0
    ...
    .line 56
    iput-object p2, p0, Lixd;->a:Liwy;

    .line 57
    return-void
.end method

.method public static a(Lcom/google/api/client/json/JsonFactory;Lcom/google/api/client/http/HttpResponse;)Lixd;
    .locals 7
    ...
    .line 90
    :try_start_1
    invoke-virtual {v0}, Liwy;->toPrettyString()Ljava/lang/String;
    :try_end_1
    ...
    invoke-direct {v0, v3, v1}, Lixd;-><init>(Lcom/google/api/client/http/HttpResponseException$Builder;Liwy;)V
