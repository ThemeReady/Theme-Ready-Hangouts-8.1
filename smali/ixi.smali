...
.method public constructor <init>(Lcom/google/api/client/http/AbstractInputStreamContent;Lcom/google/api/client/http/HttpTransport;Lcom/google/api/client/http/HttpRequestInitializer;)V
    ...
    iput-object v0, p0, Lixi;->j:Ljava/lang/String;
    ...
    iput-object v0, p0, Lixi;->k:Lcom/google/api/client/http/HttpHeaders;

    .line 213
    const-string v0, "*"

    iput-object v0, p0, Lixi;->a:Ljava/lang/String;
    ...
    iput-object v0, p0, Lixi;->d:Lcom/google/api/client/http/AbstractInputStreamContent;
    ...
    iput-object v0, p0, Lixi;->f:Lcom/google/api/client/http/HttpTransport;
    ...
    :goto_0
    iput-object v0, p0, Lixi;->e:Lcom/google/api/client/http/HttpRequestFactory;
...
.method private static a(Lcom/google/api/client/http/HttpRequest;)Lcom/google/api/client/http/HttpResponse;
    ...
    invoke-virtual {v0, p0}, Lixe;->intercept(Lcom/google/api/client/http/HttpRequest;)V
...
.method private b(Lcom/google/api/client/http/GenericUrl;)Lcom/google/api/client/http/HttpResponse;
    ...
    .line 348
    iget-object v0, p0, Lixi;->d:Lcom/google/api/client/http/AbstractInputStreamContent;

    .line 349
    iget-object v1, p0, Lixi;->g:Lcom/google/api/client/http/HttpContent;
    ...
    iget-object v3, p0, Lixi;->g:Lcom/google/api/client/http/HttpContent;

    aput-object v3, v1, v2

    const/4 v2, 0x1

    iget-object v3, p0, Lixi;->d:Lcom/google/api/client/http/AbstractInputStreamContent;
    ...
    .line 355
    :goto_0
    iget-object v1, p0, Lixi;->e:Lcom/google/api/client/http/HttpRequestFactory;

    iget-object v2, p0, Lixi;->j:Ljava/lang/String;
    ...
    iget-object v2, p0, Lixi;->k:Lcom/google/api/client/http/HttpHeaders;

    invoke-virtual {v1, v2}, Lcom/google/api/client/http/HttpHeaders;->putAll(Ljava/util/Map;)V

    .line 360
    invoke-direct {p0, v0}, Lixi;->b(Lcom/google/api/client/http/HttpRequest;)Lcom/google/api/client/http/HttpResponse;

    move-result-object v1

    .line 363
    :try_start_0
    invoke-direct {p0}, Lixi;->b()Z
    ...
    .line 364
    invoke-direct {p0}, Lixi;->c()J

    move-result-wide v2

    iput-wide v2, p0, Lixi;->o:J
...
.method private b(Lcom/google/api/client/http/HttpRequest;)Lcom/google/api/client/http/HttpResponse;
    ...
    .line 562
    :cond_0
    invoke-static {p1}, Lixi;->a(Lcom/google/api/client/http/HttpRequest;)Lcom/google/api/client/http/HttpResponse;
...
.method private c()J
    ...
    iput-wide v0, p0, Lixi;->h:J

    .line 497
    const/4 v0, 0x1

    iput-boolean v0, p0, Lixi;->i:Z

    .line 499
    :cond_0
    iget-wide v0, p0, Lixi;->h:J
...
.method private c(Lcom/google/api/client/http/GenericUrl;)Lcom/google/api/client/http/HttpResponse;
    ...
    .prologue
    .line 384
    invoke-direct {p0, p1}, Lixi;->d(Lcom/google/api/client/http/GenericUrl;)Lcom/google/api/client/http/HttpResponse;
    ...
    .line 397
    iget-object v1, p0, Lixi;->d:Lcom/google/api/client/http/AbstractInputStreamContent;

    invoke-virtual {v1}, Lcom/google/api/client/http/AbstractInputStreamContent;->getInputStream()Ljava/io/InputStream;

    move-result-object v1

    iput-object v1, p0, Lixi;->m:Ljava/io/InputStream;

    .line 398
    iget-object v1, p0, Lixi;->m:Ljava/io/InputStream;
    ...
    iget-object v2, p0, Lixi;->m:Ljava/io/InputStream;
    ...
    iput-object v1, p0, Lixi;->l:Lcom/google/api/client/http/HttpRequest;
    ...
    invoke-direct {v3, v2, v4, v5}, Liyj;-><init>(Ljava/io/InputStream;J)V

    .line 5587
    new-instance v2, Lcom/google/api/client/http/InputStreamContent;

    iget-object v4, p0, Lixi;->d:Lcom/google/api/client/http/AbstractInputStreamContent;
    ...
    iput-object v3, p0, Lixi;->a:Ljava/lang/String;
    ...
    .line 5655
    iget-object v3, p0, Lixi;->l:Lcom/google/api/client/http/HttpRequest;
    ...
    .line 5658
    iget-object v1, p0, Lixi;->l:Lcom/google/api/client/http/HttpRequest;
    ...
    iget-object v2, p0, Lixi;->l:Lcom/google/api/client/http/HttpRequest;

    invoke-direct {v1, p0, v2}, Lixk;-><init>(Lixi;Lcom/google/api/client/http/HttpRequest;)V
    ...
    invoke-static {v1}, Lixi;->a(Lcom/google/api/client/http/HttpRequest;)Lcom/google/api/client/http/HttpResponse;
    ...
    .line 426
    iget-object v0, p0, Lixi;->m:Ljava/io/InputStream;
    ...
    .line 5601
    iget-object v2, p0, Lixi;->t:[B

    if-nez v2, :cond_9

    .line 5602
    iget-object v2, p0, Lixi;->q:Ljava/lang/Byte;
    ...
    iput-object v4, p0, Lixi;->t:[B

    .line 5604
    iget-object v4, p0, Lixi;->q:Ljava/lang/Byte;

    if-eqz v4, :cond_15

    .line 5605
    iget-object v4, p0, Lixi;->t:[B

    const/4 v5, 0x0

    iget-object v6, p0, Lixi;->q:Ljava/lang/Byte;
    ...
    .line 5629
    :goto_7
    iget-object v4, p0, Lixi;->m:Ljava/io/InputStream;

    iget-object v5, p0, Lixi;->t:[B

    add-int/lit8 v6, v1, 0x1

    sub-int/2addr v6, v3

    invoke-static {v4, v5, v6, v3}, Laat;->a(Ljava/io/InputStream;[BII)I
    ...
    iput-object v2, p0, Lixi;->q:Ljava/lang/Byte;

    .line 5640
    :cond_6
    iget-object v2, p0, Lixi;->a:Ljava/lang/String;
    ...
    iput-object v2, p0, Lixi;->a:Ljava/lang/String;
    ...
    .line 5651
    iget-wide v4, p0, Lixi;->o:J

    int-to-long v6, v1

    add-long/2addr v4, v6

    iput-wide v4, p0, Lixi;->r:J
    ...
    .line 5621
    iget-object v3, p0, Lixi;->q:Ljava/lang/Byte;
    ...
    iget-object v1, p0, Lixi;->a:Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, Lixi;->b(Lcom/google/api/client/http/HttpRequest;)Lcom/google/api/client/http/HttpResponse;
...
.method private d(Lcom/google/api/client/http/GenericUrl;)Lcom/google/api/client/http/HttpResponse;
    ...
    .line 511
    iget-object v0, p0, Lixi;->g:Lcom/google/api/client/http/HttpContent;
    ...
    .line 514
    iget-object v1, p0, Lixi;->k:Lcom/google/api/client/http/HttpHeaders;
...
.method public a(Lcom/google/api/client/http/GenericUrl;)Lcom/google/api/client/http/HttpResponse;
    ...
    .line 333
    iget-boolean v0, p0, Lixi;->n:Z

    if-eqz v0, :cond_1

    .line 334
    invoke-direct {p0, p1}, Lixi;->b(Lcom/google/api/client/http/GenericUrl;)Lcom/google/api/client/http/HttpResponse;
    ...
    .line 336
    :cond_1
    invoke-direct {p0, p1}, Lixi;->c(Lcom/google/api/client/http/GenericUrl;)Lcom/google/api/client/http/HttpResponse;
...
.method public a(Lcom/google/api/client/http/HttpContent;)Lixi;
    .locals 0

    .prologue
    .line 707
    iput-object p1, p0, Lixi;->g:Lcom/google/api/client/http/HttpContent;

    .line 708
    return-object p0
.end method

.method public a(Z)Lixi;
    .locals 1
...
.method a()V
    ...
    .prologue
    .line 677
    iget-object v0, p0, Lixi;->l:Lcom/google/api/client/http/HttpRequest;
