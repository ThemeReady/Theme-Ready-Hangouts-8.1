...
.method public static a(Ljava/io/InputStream;Ljava/lang/Integer;Ljava/lang/Integer;ZZZF)Lmpz;
    .locals 9
    ...
    .line 2140
    invoke-direct {v4, v3}, Lmqi;-><init>(Landroid/graphics/Picture;)V

    .line 330
    invoke-virtual {v4, p1, p2}, Lmqi;->a(Ljava/lang/Integer;Ljava/lang/Integer;)V

    .line 331
    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lmqi;->a(Z)V

    .line 332
    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lmqi;->b(Z)V

    .line 333
    invoke-virtual {v4, p6}, Lmqi;->a(F)V

    .line 338
    new-instance v5, Lmqc;

    invoke-direct {v5, p0}, Lmqc;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-virtual {v5}, Lmqc;->a()Ljava/io/ByteArrayInputStream;
    ...
    .line 344
    iget-object v6, v6, Lmqe;->a:Ljava/util/HashMap;

    iput-object v6, v4, Lmqi;->a:Ljava/util/HashMap;
    ...
    iget-object v1, v4, Lmqi;->o:Landroid/graphics/RectF;

    invoke-direct {v0, v3, v1}, Lmpz;-><init>(Landroid/graphics/Picture;Landroid/graphics/RectF;)V

    .line 352
    iget-object v1, v4, Lmqi;->p:Landroid/graphics/RectF;
    ...
    invoke-virtual {v0, v1}, Lmpz;->a(Landroid/graphics/RectF;)V
    :try_end_0
...
.method static a(Ljava/lang/String;)Lmqg;
    .locals 10
    ...
    invoke-direct {v0, v6, v4}, Lmqg;-><init>(Ljava/util/ArrayList;I)V
    ...
    invoke-direct {v0, v6, v3}, Lmqg;-><init>(Ljava/util/ArrayList;I)V
...
.method static a(Ljava/lang/String;Lorg/xml/sax/Attributes;)Lmqg;
    .locals 3
...
.method static b(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    invoke-direct {v0, v1, v4}, Lmpy;-><init>(Ljava/lang/CharSequence;I)V

    .line 572
    invoke-virtual/range {v28 .. v28}, Lmpy;->a()V
    ...
    .line 586
    invoke-virtual/range {v28 .. v28}, Lmpy;->b()V
    ...
    .line 601
    :sswitch_0
    invoke-virtual/range {v28 .. v28}, Lmpy;->c()F
