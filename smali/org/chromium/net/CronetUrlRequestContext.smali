...
.method public constructor <init>(Lorg/chromium/net/CronetEngine$Builder;)V
    ...
    iput-object v1, p0, Lorg/chromium/net/CronetUrlRequestContext;->d:Lnjj;
    ...
    iput-object v1, p0, Lorg/chromium/net/CronetUrlRequestContext;->e:Lnjj;
    ...
    iput-object v1, p0, Lorg/chromium/net/CronetUrlRequestContext;->f:Lnjj;
    ...
    invoke-direct {v0, p0}, Lnki;-><init>(Lorg/chromium/net/CronetUrlRequestContext;)V
...
.method static b(Lorg/chromium/net/CronetEngine$Builder;)J
    ...
    invoke-virtual/range {p0 .. p0}, Lorg/chromium/net/CronetEngine$Builder;->f()Z
    ...
    invoke-virtual/range {p0 .. p0}, Lorg/chromium/net/CronetEngine$Builder;->h()Z

    move-result v4

    invoke-virtual/range {p0 .. p0}, Lorg/chromium/net/CronetEngine$Builder;->i()Ljava/lang/String;

    move-result-object v5

    invoke-virtual/range {p0 .. p0}, Lorg/chromium/net/CronetEngine$Builder;->j()Ljava/lang/String;

    move-result-object v6

    invoke-virtual/range {p0 .. p0}, Lorg/chromium/net/CronetEngine$Builder;->k()Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lorg/chromium/net/CronetEngine$Builder;->m()Z

    move-result v9

    invoke-virtual/range {p0 .. p0}, Lorg/chromium/net/CronetEngine$Builder;->o()I

    move-result v10

    invoke-virtual/range {p0 .. p0}, Lorg/chromium/net/CronetEngine$Builder;->n()J

    move-result-wide v11

    invoke-virtual/range {p0 .. p0}, Lorg/chromium/net/CronetEngine$Builder;->r()Ljava/lang/String;

    move-result-object v13

    invoke-virtual/range {p0 .. p0}, Lorg/chromium/net/CronetEngine$Builder;->s()J
    ...
    .line 115
    invoke-virtual/range {p0 .. p0}, Lorg/chromium/net/CronetEngine$Builder;->p()Ljava/util/List;
    ...
    .line 116
    iget-object v4, v2, Lnjw;->a:Ljava/lang/String;
    ...
    .line 119
    :cond_0
    invoke-virtual/range {p0 .. p0}, Lorg/chromium/net/CronetEngine$Builder;->q()Ljava/util/List;
...
.method private onRttObservation(IJI)V
    ...
    invoke-direct/range {v1 .. v6}, Lnkj;-><init>(Lorg/chromium/net/CronetUrlRequestContext;IJI)V
...
.method private onThroughputObservation(IJI)V
    ...
    invoke-direct/range {v1 .. v6}, Lnkk;-><init>(Lorg/chromium/net/CronetUrlRequestContext;IJI)V
...
.method public a(Ljava/lang/String;Lorg/chromium/net/UrlRequest$Callback;Ljava/util/concurrent/Executor;ILjava/util/Collection;)Lorg/chromium/net/UrlRequest;
    ...
    .line 134
    :try_start_1
    iget-object v0, p0, Lorg/chromium/net/CronetUrlRequestContext;->f:Lnjj;

    invoke-virtual {v0}, Lnjj;->a()Z
...
.method a(Lorg/chromium/net/CronetUrlRequest;)V
    ...
    invoke-direct {v0, p0, p1}, Lnkl;-><init>(Lorg/chromium/net/CronetUrlRequestContext;Lorg/chromium/net/CronetUrlRequest;)V
