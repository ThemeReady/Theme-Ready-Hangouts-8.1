...
.method public constructor <init>(Lorg/chromium/net/NetworkChangeNotifierAutoDetect$Observer;Landroid/content/Context;Lorg/chromium/net/NetworkChangeNotifierAutoDetect$RegistrationPolicy;)V
    ...
    invoke-direct {v0, p2}, Lnmd;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b:Lnmd;

    .line 411
    new-instance v0, Lnml;

    invoke-direct {v0, p2}, Lnml;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->f:Lnml;
    ...
    .line 1246
    invoke-direct {v0, p0}, Lnme;-><init>(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;)V
    ...
    .line 420
    :goto_0
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b:Lnmd;

    invoke-virtual {v0}, Lnmd;->a()Lnmk;

    move-result-object v0

    .line 421
    invoke-virtual {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a(Lnmk;)I
    ...
    .line 422
    invoke-direct {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->c(Lnmk;)Ljava/lang/String;
    ...
    .line 423
    invoke-virtual {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b(Lnmk;)D
    ...
    iget-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->f:Lnml;

    invoke-virtual {v1}, Lnml;->c()Z

    move-result v1

    invoke-direct {v0, v1}, Lnmj;-><init>(Z)V

    iput-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->c:Lnmj;
...
.method private c(Lnmk;)Ljava/lang/String;
    .locals 2

    .prologue
    .line 663
    invoke-virtual {p0, p1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a(Lnmk;)I
    ...
    :cond_0
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->f:Lnml;

    invoke-virtual {v0}, Lnml;->a()Ljava/lang/String;
...
.method private d(Lnmk;)V
    ...
    .line 681
    invoke-direct {p0, p1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->c(Lnmk;)Ljava/lang/String;
...
.method private e(Lnmk;)V
    .locals 4

    .prologue
    .line 691
    invoke-virtual {p0, p1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b(Lnmk;)D
...
.method public b(Lnmk;)D
    ...
    .line 600
    iget-object v2, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->f:Lnml;

    invoke-virtual {v2}, Lnml;->b()I
...
.method public b()V
    ...
    .line 469
    :cond_1
    invoke-virtual {p0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->d()Lnmk;

    move-result-object v0

    .line 470
    invoke-direct {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->d(Lnmk;)V

    .line 471
    invoke-direct {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->e(Lnmk;)V

    .line 472
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->d:Landroid/content/Context;

    iget-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->c:Lnmj;
    ...
    invoke-virtual {v0, v1, v2}, Lnmd;->a(Landroid/net/NetworkRequest;Landroid/net/ConnectivityManager$NetworkCallback;)V

    .line 482
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b:Lnmd;

    invoke-virtual {v0}, Lnmd;->b()[Landroid/net/Network;
...
.method public c()V
    ...
    invoke-virtual {v0, v1}, Lnmd;->a(Landroid/net/ConnectivityManager$NetworkCallback;)V

    goto :goto_0
.end method

.method public d()Lnmk;
    .locals 1
...
.method public e()[I
    ...
    .line 524
    iget-object v7, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b:Lnmd;

    invoke-virtual {v7, v6}, Lnmd;->b(Landroid/net/Network;)Z
    ...
    iget-object v8, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b:Lnmd;

    invoke-virtual {v8, v6}, Lnmd;->a(Landroid/net/Network;)Lnmk;

    move-result-object v6

    invoke-virtual {p0, v6}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a(Lnmk;)I
