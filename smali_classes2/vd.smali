...
.method public constructor <init>(Landroid/support/v7/internal/widget/ActivityChooserView;)V
    ...
    .prologue
    .line 266
    iput-object p1, p0, Lvd;->a:Landroid/support/v7/internal/widget/ActivityChooserView;
...
.method public onChanged()V
    ...
    .line 270
    iget-object v0, p0, Lvd;->a:Landroid/support/v7/internal/widget/ActivityChooserView;

    .line 1521
    iget-object v1, v0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Lve;

    invoke-virtual {v1}, Lve;->getCount()I
    ...
    invoke-virtual {v1}, Lve;->c()I

    move-result v1

    .line 1528
    iget-object v2, v0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Lve;
    ...
    invoke-virtual {v1}, Lve;->b()Landroid/content/pm/ResolveInfo;
    ...
    .line 1545
    iget-object v1, v0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Lza;

    iget-object v0, v0, Landroid/support/v7/internal/widget/ActivityChooserView;->c:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v0}, Lza;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 1547
    :cond_4
    iget-object v0, v0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Lza;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lza;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
