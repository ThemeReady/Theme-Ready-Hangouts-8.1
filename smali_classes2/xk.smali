...
.method constructor <init>(Landroid/widget/ProgressBar;Lwb;)V
    .locals 0
    ...
    .line 52
    iput-object p1, p0, Lxk;->c:Landroid/widget/ProgressBar;

    .line 53
    iput-object p2, p0, Lxk;->a:Lwb;
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 81
    invoke-direct {p0, v0, p2}, Lxk;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Lxk;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 104
    iget-object v0, p0, Lxk;->d:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 105
    iput-object v1, p0, Lxk;->d:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 57
    iget-object v0, p0, Lxk;->c:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Lxk;->b:[I

    invoke-static {v0, p1, v1, p2, v3}, Lwc;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lwc;

    move-result-object v4

    .line 60
    invoke-virtual {v4, v3}, Lwc;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 62
    iget-object v5, p0, Lxk;->c:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Lxk;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 65
    :cond_2
    invoke-virtual {v4, v9}, Lwc;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 67
    iget-object v1, p0, Lxk;->c:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Lxk;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
